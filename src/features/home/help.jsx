    ...
    <section className="container mx-auto py-5 px-5">
      <div>
        ...
        <P className="text-center py-5">
          ...
          except your email address. The email address provided will primarily
          be used for communication. A short questionnaire will also be asked
          after you register so that we know the demographic of the
          volunteers! Once that&apos;s finished, you can start contributing to
          Atlas by doing 3 tasks:
        </P>
      </div>
      <div ref={ref}>
        <ul className="flex flex-row flex-wrap justify-around ml-8 lg:h-60">
          <li className={`duration-500 ease-in ${styles.card} ${!isVisible ? 'opacity-0 pl-10' : 'pt-0 opacity-100'}`}>
            <H3>
              <span>#1</span>
              <span>Identify</span>
            </H3>
          ...
          <li className={`duration-700 ease-in ${styles.card} ${!isVisible ? 'opacity-0 pl-10' : 'pt-0 opacity-100'}`}>
            <H3>
              {' '}
              <span>#2</span>
          ...
          <li className={`duration-1000 ease-in ${styles.card} ${!isVisible ? 'opacity-0 pl-10' : 'pt-0 opacity-100'}`}>
            <H3>
              <span>#3</span>
              <span>Score</span>
            </H3>

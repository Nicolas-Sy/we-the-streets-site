      ...
      <div className="px-4 mx-auto">
        ...
        <div className="md:flex justify-between md:flex-wrap md:-mx-4 md:pb-6">
          ...
          <div className="lg:w-1/3 md:px-4 mb-4">
            <h4 className="text-white text-2xl">Thank you for joining us in knowing our streets better.</h4>
            <p className="text-gray-400">Feel free to send us a message, view our repository, or read our paper.</p>
            <div className="flex flex-wrap">
              <a className={styles.button} href="mailto:lynux_ansay@dlsu.edu.ph" target="_blank" rel="noreferrer">
                <svg
        ...
        <div className="px-4 mx-auto">
          ...
          <div className="md:flex md:-mx-4 md:items-center">
            ...
            <div className="md:flex-1 md:px-4 text-center md:text-right">
              <Link href="/terms-of-service"><span className="cursor-pointer py-2 px-4 text-white inline-block hover:underline"> Terms of Service</span></Link>
              <Link href="/privacy-policy"><span className="cursor-pointer py-2 px-4 text-white inline-block hover:underline"> Privacy Policy </span></Link>
            </div>
          </div>
